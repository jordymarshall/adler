...
function ScrollJourney() {
  ...
  return <section className="phone-journey" id="the-path" ref={journey} style={{ "--story-frames": landingFrames.length } as CSSProperties} aria-label="One goal, from first plan to learning what helps">
    ...
    <div className="phone-story" ref={stage} data-screen={beat.screen} data-frame={active} onKeyDown={onKeyDown} tabIndex={0} aria-label="Scroll or use the left and right arrow keys to follow the goal.">
